            ...
            <div class="w3l-welcome-info">
                <div class="col-sm-6 col-xs-6 welcome-grids">
                    <div class="welcome-img">
                        <img src="{{asset('/')}}front-end/images/about.jpg" class="img-responsive zoom-img" alt="">
                    </div>
                </div>
                <div class="col-sm-6 col-xs-6 welcome-grids">
                    <div class="welcome-img">
                        <img src="{{asset('/')}}front-end/images/about2.jpg" class="img-responsive zoom-img" alt="">
                    </div>
                </div>
            ...
            <div class="about-tp">
                ...
                <div class="col-md-4 about-agileits-w3layouts-right">
                    <div class="img-video-about">
                        <img src="{{asset('/')}}front-end/images/videoimg2.png" alt="">
                    </div>
