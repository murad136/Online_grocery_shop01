                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{route('edit-product',['id'=>$order->id])}}" class="btn btn-primary btn-xs" title="Edit Order">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                    <a href="{{route('delete-product',['id'=>$order->id])}}" class="btn btn-danger btn-xs" onclick="return confirm('Are sure delete this ??? ')">
